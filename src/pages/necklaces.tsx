...
const mockNecklaces: Necklace[] = [
  ...
  },
  {
    ...
    price: 449,
    image: "/placeholder-necklace-7.jpg",
    category: "Lockets",
    rating: 4.4,
    reviews: 76,
    inStock: true,
  ...
  },
  {
    ...
    price: 2499,
    image: "/placeholder-necklace-8.jpg",
    category: "Tennis",
    rating: 4.9,
    reviews: 145,
    inStock: true
...
const Necklaces: React.FC = () => {
  ...
  const categories = ['all', 'pendants', 'pearls', 'chains', 'statement', 'layered', 'chokers', 'lockets', 'tennis'];
  const sortOptions = [
  ...
  const filteredNecklaces = mockNecklaces.filter(necklace => {
    const matchesCategory = selectedCategory === 'all' || necklace.category.toLowerCase() === selectedCategory;
      ...
      <section className="relative bg-gradient-to-r from-slate-800 via-slate-700 to-slate-800 text-white py-20 sm:py-32">
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl sm:text-2xl text-slate-200 max-w-3xl mx-auto leading-relaxed">
            Adorn yourself with our stunning collection of necklaces, from delicate pendants to bold statement pieces
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 sm:gap-8">
          {sortedNecklaces.map((necklace) => (
            <div key={necklace.id} className="group bg-white rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 overflow-hidden border border-slate-200 hover:border-amber-400/30">
              {/* Product Image */}
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <span className={`text-sm font-medium px-2 py-1 rounded-full ${
                    ...
                    {necklace.inStock ? 'In Stock' : 'Out of Stock'}
                  </span>
                </div>
              </div>
            </div>
